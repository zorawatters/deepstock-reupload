<template>
  <div class="container">
    <b-row class="p-2">
      <main-card title="Stock Graph" custom ="card shadow col-lg-7 col-md-7 col-sm-10 offset-sm-1 p-2 m-4">
        <stock-card></stock-card>
      </main-card>
      <main-card title="Toggle" custom ="card shadow col-lg-4 col-md-4 col-sm-10 offset-sm-1 p-2 m-4">
    ...
    <b-row class="p-2">
      <main-card title="Twitter Card" custom ="card shadow col-lg-5 col-md-6 col-sm-6 p-1 offset-lg-1 col-sm-10 offset-sm-1 p-2 m-4"><twitter-card custom = "bg-secondary"></twitter-card></main-card>
      <main-card title="Sentiment Card" custom ="card shadow col-lg-5 col-md-6 col-sm-6 p-1 offset-lg-1 col-sm-10 offset-sm-1 p-2 m-4"><sentiment-card custom = "bg-secondary"></sentiment-card></main-card>
